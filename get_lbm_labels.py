...
filename_prefix = 'utrecht_2020_1m'
out_dir = f"tiles/"
# Input CRS is RD New, 28992
subset_bbox = (139267, 456844, 139267+4000, 456844+4000) # Lazy test coords
...
offset = 900 # Pad the raster with extra pixels to allow side-overlap on the final raster
